...
import type { Product as _Product, ProductView as _ProductView, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: Array<string>, arg4: string | null): Promise<Product> {
        if (this.processError) {
            try {
    ...
    async getProductById(arg0: bigint): Promise<ProductView | null> {
        if (this.processError) {
            try {
    ...
    async getProductsBySection(arg0: string): Promise<Array<ProductView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProductsBySection(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: string | null): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_ProductView_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductView): ProductView {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProductView]): ProductView | null {
    return value.length === 0 ? null : from_candid_ProductView_n8(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        title: value.title,
        sectionTags: value.sectionTags,
        imageUrl: value.imageUrl,
        badge: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.badge))
    };
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductView>): Array<ProductView> {
    return value.map((x)=>from_candid_ProductView_n8(_uploadFile, _downloadFile, x));
}
